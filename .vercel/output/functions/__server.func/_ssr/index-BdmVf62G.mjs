...
import { S as SiteFrame, a as SiteHeader, b as SiteFooter, p as projects } from "./site-chrome-DIhAFbAk.mjs";
import { C as ChevronDown, A as ArrowUpRight } from "../_libs/lucide-react.mjs";
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto mb-12 max-w-3xl text-center md:mb-16", children: [
...
function WorkSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "work", className: "work-section scroll-mt-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-select", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "work-select", className: "sr-only", children: "Select work experience" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("select", { id: "work-select", value: selected.id, onChange: (event) => setActiveWork(event.target.value), children: workItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item.id, children: item.navLabel }, item.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { "aria-hidden": "true", className: "work-select__icon" })
      ] }),
...
function ProjectsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "projects", className: "mt-12 scroll-mt-24 md:mt-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-rule-heading", children: [
